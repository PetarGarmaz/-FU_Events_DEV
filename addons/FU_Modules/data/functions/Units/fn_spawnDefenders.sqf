params ["_groupPos", "_factionComp", "_type", "_spawnRadius", "_patrolRadius", ["_expression", ""]]; //0 - Squad; 1 - Fireteam; 2 - Techie; 3 - APC; 4 - Tank; 5 - Heli; 6 - Plane;
...
//Execute expression for each unit in group
if(_expression != "") then {
	_code = compile _expression;

	{call _code}foreach (units _group);
};
